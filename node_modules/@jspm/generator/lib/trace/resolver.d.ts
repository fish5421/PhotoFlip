...
export declare class Resolver {
    ...
    env: string[];
    cjsEnv: string[];
    constructor(env: string[], log: Log, fetchOpts?: any, preserveSymlinks?: boolean);
    ...
    finalizeResolve(url: string, parentIsCjs: boolean, pkgUrl: `${string}/`): Promise<string>;
    getExportResolution(pkgUrl: `${string}/`, subpath: "." | `./${string}`, originalSpecifier: string): Promise<"." | `./${string}` | null>;
    resolveExport(pkgUrl: `${string}/`, subpath: `.${string}`, cjsEnv: boolean, parentIsCjs: boolean, originalSpecifier: string, installer: Installer, parentUrl?: URL): Promise<string>;
    analyze(resolvedUrl: string, parentUrl: string, system: boolean, isRequire: boolean, retry?: boolean): Promise<Analysis>;
